...
const APP_ASSETS = [
  ...
  './assets/images/backgrounds/bg-balloon.jpg',
  './assets/images/backgrounds/bg-lantern.jpg',
  ...
  './assets/audio/sfx/machine-excavator.mp3',
  './assets/audio/sfx/machine-bulldozer.mp3',
  './assets/audio/sfx/machine-dumptruck.mp3',
  './assets/audio/sfx/machine-crane.mp3',
  './assets/audio/sfx/machine-mixer.mp3',
  './assets/audio/sfx/machine-forklift.mp3',
  './assets/audio/sfx/machine-roller.mp3',
  './assets/audio/sfx/machine-loader.mp3',
  './assets/audio/sfx/machine-tractor.mp3',
  './assets/audio/sfx/machine-towtruck.mp3',
  './assets/images/items/lantern-red.png',
  './assets/images/items/lantern-orange.png',
  './assets/images/items/lantern-gold.png',
  './assets/images/items/lantern-pink.png',
  './assets/images/items/lantern-green.png',
  './assets/images/items/lantern-blue.png',
  './assets/images/items/machine-excavator.png',
  './assets/images/items/machine-bulldozer.png',
  './assets/images/items/machine-dumptruck.png',
  './assets/images/items/machine-crane.png',
  './assets/images/items/machine-mixer.png',
  './assets/images/items/machine-forklift.png',
  './assets/images/items/machine-roller.png',
  './assets/images/items/machine-loader.png',
  './assets/images/items/machine-tractor.png',
  './assets/images/items/machine-towtruck.png',
